...
//   // germanVoice = window.speechSynthesis.getVoices();
//   germanVoice = window.speechSynthesis.getVoices().find(voice => voice.lang === "de-DE");
...
function computerOutput(computerSpeech) {
  let audio = new Audio("public/audioFiles/1.mp3");
  console.log(audio);
  audio.play();
