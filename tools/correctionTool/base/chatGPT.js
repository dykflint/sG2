var OPENAI_API_KEY = "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";
...
function Send() {
    ...
    var sQuestion = "List the mistakes in the following german text but do not correct them:" + txtMsg.value;
    if (sQuestion == "") {
