...
function Send1(command) {
  ...
  var sQuestion = command + txtMsg.value;
  originalText = txtMsg.value;
  if (sQuestion == "") {
    ...
    if (oHttp.readyState === 4) {
      ...
      if (oJson.error && oJson.error.message) {
        ...
        if (s == "") {
          ...
          hintsDiv = document.querySelector("#hints");
          hintsDiv.innerHTML = s;
    ...
    if (oHttp.readyState === 4) {
      ...
      if (oJson.error && oJson.error.message) {
        ...
        if (s == "") {
          ...
          correctAnswerDiv = document.querySelector("#correct-answer");
          correctAnswerDiv.innerHTML = s;
          // txtMsg.value += "Chat GPT: " + s;
          console.log(s.split());
        }
      }
...
function callGPT() {
  ...
  Send2(
    "Given the following text tell me why the word schoener is wrong in this context and keep it short:",
  );
  Send3(
    "Schoener is not correct in the following text. Can you give me the correct version of the word?: Es isst ein schoener Montagmorgen.",
  );
}
