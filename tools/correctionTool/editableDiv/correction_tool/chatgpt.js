...
function Send2(incorrectWord) {
    ...
    // var sQuestion = txtMsg.value;
    // var sQuestion = "Can you correct the following german text and explain the mistakes?:" + txtMsg.value;
    var sQuestion = 'Given the following text tell me why the word' + incorrectWord +'is wrong in this context and keep it short:' + txtMsg.textContent;
    if (sQuestion == "") {
        alert("Type in your question!");
        txtMsg.focus();
        return;
...
function Send3(incorrectWord) {
    ...
    // var sQuestion = txtMsg.value;
    // var sQuestion = "Can you correct the following german text and explain the mistakes?:" + txtMsg.value;
    var sQuestion = "The word " + incorrectWord + " is wrong in the following sentence, could you give me a hint on what is wrong without giving me the correct answer?: " + txtMsg.textContent;
    if (sQuestion == "") {
        alert("Type in your question!");
        txtMsg.focus();
        return;
