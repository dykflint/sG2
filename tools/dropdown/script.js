...
function showHideFunction_k(content) {
  elements = document.getElementsByClassName("menu-content-konstantin");
  for (var i = 0; i < elements.length; i++) {
    elements[i].classList.add("hide-konstantin");
  }
  document.getElementById(content).classList.remove("hide-konstantin");
}
